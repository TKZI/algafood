...
import com.ticruz.algafood.api.assembler.ProdutoInputDissassembler;
import com.ticruz.algafood.api.assembler.ProdutoModelAssembler;
import com.ticruz.algafood.api.model.ProdutoModel;
...
public class RestauranteProdutoController {
	...
	@Autowired
	private ProdutoInputDissassembler produtoInputDissassembler;
	...
	public ProdutoModel adicionar(@PathVariable Long restauranteId ,@RequestBody @Valid ProdutoInput produtoInput) {
		Restaurante restaurante = cadastroRestaurante.buscarOuFalhar(restauranteId);
		Produto produto = produtoInputDissassembler.toDomainObject(produtoInput);
	...
	public ProdutoModel atualizar (@PathVariable Long restauranteId,@PathVariable Long produtoId, @RequestBody @Valid ProdutoInput produtoInput) {
		...
		produtoInputDissassembler.copyToDomainObject(produtoInput, produtoAtual);
